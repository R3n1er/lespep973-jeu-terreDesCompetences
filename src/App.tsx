    ...
    <div className="min-h-screen bg-neutral-50">
      <header className="mx-auto flex w-full max-w-5xl flex-col items-center gap-6 px-6 py-16 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <button className="rounded-lg bg-brand-primary px-6 py-3 text-base font-semibold text-white shadow-card transition hover:brightness-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-secondary">
            Démarrer le développement
          </button>
          <button className="rounded-lg border border-brand-primary px-6 py-3 text-base font-semibold text-brand-primary transition hover:bg-brand-primary/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary">
